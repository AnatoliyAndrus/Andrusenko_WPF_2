using Andrusenko_WPF_2.Tools;
using Andrusenko_WPF_2.Models;
using System.ComponentModel;
using System.Runtime.CompilerServices;
using System.Windows;
using System.Windows.Input;

namespace Andrusenko_WPF_2.ViewModels
{
    public class PersonViewModel : INotifyPropertyChanged
    {
        ...
        private async Task ExecuteProceedCommandAsync()
        {
            ...
            bool isAgeInvalid = await Task.Run(() => IsAgeInvalid(age));
        ...
        private bool IsAgeInvalid(int age)
        {
